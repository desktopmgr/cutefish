...
# @File          : cutefish
# @Description   : Installer script for cutefish
# @TODO          :
# @Other         :
# @Resource      :
# - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -
...
# - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -
# Other functions
cutefish() { builtin type -P "cutefish-session" && return 0 || return 1; }
# - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -
...
run_postinst() {
  desktopmgr_run_post
  [[ -d "${APPDIR}os" ]] && rm_rf "${APPDIR}os"
  mv -fv "$APPDIR" "${APPDIR}os"
}
#
